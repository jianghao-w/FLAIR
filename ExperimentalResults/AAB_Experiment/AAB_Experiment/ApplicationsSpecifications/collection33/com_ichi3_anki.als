...
one sig com_cachedthought_dynamicstats_Statistics extends Activity{}{
...
one sig com_ichi3_anki_IntentHandler extends Activity{}{
	app in com_ichi3_anki
	intentFilter = IntentFilter3 + IntentFilter3 + IntentFilter3 + IntentFilter3
	no detailedPaths
	no compPermissions
}
...
one sig com_ichi3_anki_NoteEditor extends Activity{}{
	app in com_ichi3_anki
	intentFilter = IntentFilter4 + IntentFilter4
	no detailedPaths
	no compPermissions
}
...
one sig IntentFilter1 extends IntentFilter{}{
	...
	dataScheme=NoScheme + NoScheme + NoScheme + NoScheme + NoScheme + YesScheme + YesScheme
}
