...
open org_arguslab_icc_implicit_data2

one sig intent1__smc21k6fqco62ttja3plo1inn5 extends Intent{}{
//  org_arguslab_icc_implicit_data2_MainActivity: void leakImei()
    sender=org_arguslab_icc_implicit_data2_MainActivity
	no component
	action=test_A
	categories=android_intent_category_DEFAULT_C
	dataType=NoMIMEType
	dataScheme=NoScheme
	detailedPaths=detailedPath_org_arguslab_icc_implicit_data2_2 + detailedPath_org_arguslab_icc_implicit_data2_3
}



fact {
existingApps.apps = org_arguslab_icc_implicit_data2
}
