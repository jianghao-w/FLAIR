...
one sig intent1__qa46lddaa5rko6k95rkclafnmn extends Intent{}{
...
run generateInfoLeak for 1 but exactly 3 Application, exactly 3 Activity, exactly 2 Service, exactly 0 Receiver, exactly 4 IntentFilter, exactly 2 Intent, exactly 5 DetailedPath

pred generateActivityLunch{
 some GeneratedExpActivityLunch
}
//The exact number of each element is the one shown minus one (except Service, Receiver & IntentFilter (=))
run generateActivityLunch for 1 but exactly 3 Application, exactly 3 Activity, exactly 2 Service, exactly 0 Receiver, exactly 3 IntentFilter, exactly 1 Intent, exactly 4 DetailedPath
...
run generateIntentHijack for 1 but exactly 3 Application, exactly 3 Activity, exactly 2 Service, exactly 0 Receiver, exactly 4 IntentFilter, exactly 1 Intent, exactly 3 DetailedPath
